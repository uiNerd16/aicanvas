...
function buildFaq(
  ...
  if (Object.keys(entry.prompts).length > 0) {
    faq.push({
      ...
      a: isPremium
        ? `Yes. Open "Remix with AI" on this page to read the setup, how ${entry.name} works, what to change, and how to check the result, then copy it into Claude, Cursor, ChatGPT, or any AI tool. The constants, the engine and the markup are part of Premium. For the exact ${noun}, install it with the one-command CLI.`
