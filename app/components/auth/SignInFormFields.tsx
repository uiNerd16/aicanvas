...
// ─── SignInFormFields ─────────────────────────────────────────────────────────
// The actual sign-in form (heading + Google + email/password + forgot link).
// Shared between:
  ...
  return (
    <>
      <img
        ...
        className="h-7 w-7"
      />
      <h1 className="mt-5 text-2xl font-bold leading-tight text-sand-900 dark:text-sand-50 sm:text-3xl">
        Sign in to unlock the best of AI Canvas.
      </h1>
