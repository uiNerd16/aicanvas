...
import { ArrowElbowDownRight, CaretDown, ChatCircleText, DiamondsFour, EnvelopeSimple, Flask, FlowArrow, GithubLogo, Info, MagnifyingGlass, PiggyBank, Plug, Question, X, XLogo } from '@phosphor-icons/react'
    ...
    <aside className="flex h-full w-60 shrink-0 flex-col border-r border-sand-300 bg-sand-200 dark:border-sand-800 dark:bg-sand-950">
      ...
      <div className="shrink-0 px-3 pt-2 pb-1">
        ...
        <div className="space-y-0.5">
          ...
          >
            <FlowArrow weight="regular" size={16} />
