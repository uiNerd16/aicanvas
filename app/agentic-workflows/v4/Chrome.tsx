...
export const CATALOG_HREF = '/agentic-workflows/v4'
export const MEMORY_HREF = '/agentic-workflows/v4/memoryhd'
export const CAGE_HREF = '/agentic-workflows/v4/gpt-cage'

const CATALOG_LABEL = '/Agentic workflows'

// Sticky bar shared by the hub and both product pages. The label always leads
// back to the hub, so a product page is never a dead end.
      ...
      <div className="mt-5 grid gap-4 sm:grid-cols-2">
        ...
        >
          ...
          <p className="mt-2 text-sm text-sand-600 dark:text-sand-400">
            Back to the hub, and to what is being packaged next.
          </p>
        </Link>
      </div>
    </section>
