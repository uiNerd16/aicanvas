...
// so the terminal fills the viewport. The block opens in a new tab —
// the exit button closes the tab; if the browser refuses, we fall back
// to the Andromeda showcase.
