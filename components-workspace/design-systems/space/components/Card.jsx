...
const cardVariants = cva(
  ...
  ],
  {
    variants: {
      variant: {
        default: ['bg-[color:var(--space-surface-raised)]'],
        glow:    ['bg-[image:var(--space-gradient-accent-sweep)]'],
      },
      bordered: {
    ...
    compoundVariants: [
      { variant: 'default', bordered: true, class: 'border-[color:var(--space-border-base)]' },
      { variant: 'glow',    bordered: true, class: 'border-[color:var(--space-accent-dim)]' },
    ],
    defaultVariants: {
      variant: 'default',
      bordered: false,
 ...
 * @property {boolean} [bordered=false] Toggle a continuous 1px border. Off by default — Space cards rely on corner brackets, not perimeter strokes.
  ...
  return (
    <div
      ...
      className={cn(
        ...
        'border-b border-solid border-[color:var(--space-border-subtle)]',
        className,
      )}
      {...props}
    >
...
export const CardContent = forwardRef(function CardContent(
  ...
  return (
    <div
      ...
      className={cn('p-[var(--space-3)]', className)}
      {...props}
    >
      {children}
    </div>
