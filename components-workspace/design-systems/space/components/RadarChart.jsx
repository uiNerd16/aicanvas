...
// Space-styled radar/spider chart built on recharts primitives.
// No shadcn chart wrapper needed — everything is styled directly
// via space tokens and inline SVG overrides.
//
// Props:
...
function SpaceTooltip({ active, payload, label, series, onFirstActive }) {
  ...
  return (
    <div style={{
      ...
      animation: 'space-tooltip-in 400ms cubic-bezier(0.25,1,0.5,1) both',
      minWidth: 120,
    }}>
      <div style={{
...
export const RadarChart = forwardRef(function RadarChart(
  ...
  return (
    ...
    >
      ...
      <div style={{ padding: `${tokens.spacing[4]} ${tokens.spacing[2]}`, position: 'relative' }}>
        ...
        {!scanDone && (
          <div aria-hidden="true" style={{
            ...
            animation: 'space-radar-scan 1.1s ease-out forwards',
            pointerEvents: 'none',
            zIndex: 2,
          }} />
        )}
      ...
      <style>{`
        @keyframes space-radar-scan {
          from { top: 0%; opacity: 0.8; }
          to   { top: 100%; opacity: 0; }
        }
        @keyframes space-tooltip-in {
