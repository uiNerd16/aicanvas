...
const PAGE_BG = '#1a1a19'
const PANEL_BG = '#efeee6'
const INK = '#1a1a19'
  ...
  return (
    <div
      ...
      style={{
        ...
        // Perspective on the outer wrapper — sets the camera distance for the
        // homography warp on the inner word container.
        perspective: '1400px',
        perspectiveOrigin: '50% 50%',
      }}
    >
      {/* Single Anton import for the whole component tree. */}
      ...
      >
        {/* Hover zone — tight area around the text only. Events live here. */}
        <div
          ref={panelRef}
        ...
        >
        {/* Warped container — everything inside gets corner-pinned by the
            matrix3d transform. transform-origin is always '0 0'. */}
        <div
          ref={warpRef}
          className="relative"
          style={{
